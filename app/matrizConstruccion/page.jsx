...
const MatrizBetaHome = () => {
    ...
    const handleClickDefinicion = (idPalabra) => {
        ...
        console.log("AAAA palabraObjeto.inferencias = ", palabraObjeto.inferencias)
        const arrayInferencias = Object.entries(palabraObjeto.inferencias).map(([id, definicionesIds]) => {
          console.log("OJO = ", dataSet.palabras, id)
    ...
    //             if (definicionesCorrespondientes.length > 0) {
    ...
    //       console.log(`9-Inferencias de la palabra actual: ${JSON.stringify(inferencias)}`);
    //     });
